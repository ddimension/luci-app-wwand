...
/* ONE SERIES PER RAT, one GROUP PER QUANTITY. Slots:
     rsrp = [ RSRP LTE, RSRP 5G, RSCP 3G, RSSI LTE, RSSI 3G, RSSI 2G, RSSI ]
...
const NONE = { rsrp: [ null, null, null, null, null, null, null ], sinr: [ null, null ],
               rsrq: [ null, null ], ecio: [ null ] };
const S_ = (over) => JSON.stringify(Object.assign({}, NONE, over));

eq(S({ nr5g: { rsrp: -106, snr: 160 }, lte: { rsrp: -94, snr: 240, rsrq: -9 } }),
   S_({ rsrp: [ -94, -106, null, null, null, null, null ], sinr: [ 24, 16 ], rsrq: [ -9, null ] }),
...
eq(S({ lte: { rssi: -66, rsrq: -17, rsrp: -100, snr: 138 },
   ...
   S_({ rsrp: [ -100, null, null, -66, null, null, null ], sinr: [ 13.8, null ], rsrq: [ -17, -11 ] }),
...
eq(S({ wcdma: { rscp: -95, rssi: -80, ecio: -7.5 } }),
   S_({ rsrp: [ null, null, -95, null, -80, null, null ], ecio: [ -7.5 ] }),
   'signalSample: 3G plots rscp and rssi as separate lines');
eq(S({ wcdma: { rssi: -80, ecio: -7.5 } }),
   S_({ rsrp: [ null, null, null, null, -80, null, null ], ecio: [ -7.5 ] }),
...
eq(S({ wcdma: { rscp: -95, ecno: -9 } }),
   S_({ rsrp: [ null, null, -95, null, null, null, null ], ecio: [ -9 ] }),
   'signalSample: ecno is the same measure as ecio');

eq(S({ gsm_rssi: -78 }), S_({ rsrp: [ null, null, null, null, null, -78, null ] }),
...
eq(S({ lte: { rsrp: -94, snr: 240, rsrq: -9 } }),
   S_({ rsrp: [ -94, null, null, null, null, null, null ], sinr: [ 24, null ], rsrq: [ -9, null ] }),
   'signalSample: lte-only leaves a gap in the 5G series');

eq(S({ nr5g: { rsrp: -88, snr: 180, rsrq: -11 } }),
   S_({ rsrp: [ null, -88, null, null, null, null, null ], sinr: [ null, 18 ], rsrq: [ null, -11 ] }),
...
eq(S({ rssi: -101 }), S_({ rsrp: [ null, null, null, null, null, null, -101 ] }),
...
eq(S({ lte: { rssi: -84 } }), S_({ rsrp: [ null, null, null, -84, null, null, null ] }),
...
eq(S({ lte: { snr: 0, rsrp: -100 } }),
   S_({ rsrp: [ -100, null, null, null, null, null, null ], sinr: [ 0, null ] }),
